...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        RegistrationMapper registrationMapper1 = new RegistrationMapper(db);
        ...
        */
        ...
        /*
        System.out.println("printing key and value from hashmap memberMapper.getNumberOfParticipantOfTeam()");
        for (Map.Entry<String, Integer> entry : memberMapper.getNumberOfParticipantOfTeam().entrySet()) {
            System.out.println(entry.getKey() + ": " + entry.getValue());
        }


        for (Team t: memberMapper.numberOfParticipantOfTeam()) {

            System.out.println(t.getTeamName() + ": " + t.getTotalParticipant());

        }

         */

        //registrationMapper1.addToTeam(13, "ten01", 108);

        for (RegistrationDTO r: registrationMapper1.getAllRegistrations()) {
            System.out.println("name: "+r.getName()+", gender:"+r.getGender()+", team: "+r.getTeam_id()+", price: "+r.getPrice());
